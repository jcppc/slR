...
Once the Excel files are completed with the articles eveluation details, the two Excel files should be loaded to finish the generation of the SLR components (latex and plot files).
**Note:** You can skip **Step 1** if you have already the articles metadata Excel files already created.
